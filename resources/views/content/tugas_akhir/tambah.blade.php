                    ...
                    <div class="card">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active">Form ta</li>
                                    </ol>
                                </div>
                                <div class="col-md-4">
                        ...
                        <div class="card-body">
                            <div class="col-md-8 col-12 mr-auto ml-auto border-form">
                                <form action="{{ url('tugas-akhir/tambah') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <label class="col-md-3 col-form-label text-left">Judul ta</label>
                                        <div class="col-md-9">
                                            <div class="form-group bmd-form-group">
                                                <label class="bmd-label-floating">masukan judul ta</label>
                                                <input type="text" class="form-control" name="judul_ta">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <label class="col-md-3 col-form-label text-left">Tempat TA</label>
                                        <div class="col-md-9">
                                            <div class="form-group bmd-form-group">
                                                <label class="bmd-label-floating">masukan tempat ta</label>
                                                <input type="text" class="form-control" name="tempat_ta">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-9 m15">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-check form-check-inline">
                                                        <label class="form-check-label">
                                                          <input class="form-check-input" type="checkbox" name="dokumen_persyaratan[]" value="form_ta"> Form Pengajuan TA
                                                          <span class="form-check-sign">
                                                              <span class="check"></span>
                                                          </span>
                                                        </label>
